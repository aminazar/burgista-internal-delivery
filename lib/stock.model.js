...
class Stock extends SqlTable {
  ...
  static exportDataToSave(data) {
    ...
    if (data[idColumn]) {
      ...
      // when time is between 00:00:00 AM  into 10:00:00 need to 
      if (Stock.dateIsBetween('00:00:01', '09:59:59')) {
  ...
  static checkingSubmissionTime() {
    if (!Stock.dateIsBetween('22:00:01', '23:59:59') && !Stock.dateIsBetween('00:00:01', '09:59:59')) {
  ...
  static checkingTime(isBranch) {
    if (Stock.dateIsBetween('10:00:01', '21:59:59')) {
      return Promise.resolve(false);
    }
    return Promise.resolve(true);
  }
