          ...
          .then((res) => {
            ...
            while (countDate >= previousLoginDate) {
              for (let productIndex = 0; productIndex < res.length; productIndex++) {
                ...
                console.log('**********');
                console.log(res[productIndex].default_date_rule);
                console.log(previousLoginDate);
                console.log(moment(countDate).add(1, 'day'));
                console.log(res[productIndex].name);
                console.log('**********');
