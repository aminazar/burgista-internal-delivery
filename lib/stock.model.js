                    ...
                    product_ids.forEach(product_id => {
                        ...
                        if (coupleArray.length===2) { // if couple found
                            ...
                            if (!couples[coupleArray[0].delivery_id]) { // check if this couple has been found
                              console.log('****+++****');
                              console.log('coupleArray[0]:',coupleArray[0]);
                              console.log('coupleArray[1]:',coupleArray[1]);
                              console.log('****+++****');
                                ...
                                console.log('daysFromLastCounting:',daysFromLastCounting);
