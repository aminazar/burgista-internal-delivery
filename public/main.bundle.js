...
exports.Unit = Unit;
//# sourceMappingURL=G:/burgista/burgista-delivery-client/src/unit.js.map
...
var PrintService = (function () {
    ...
    PrintService.prototype.printData = function () {
        ...
        var rowNum = 0;
        if (this._isOverallPrint) {
            for (var _i = 0, _a = this.totalDeliveries; _i < _a.length; _i++) {
                var item = _a[_i];
                rowNum++;
                var cl = rowNum % 2 ? '' : ' class="highlight"';
                innerContentTable += "\n        <tr>\n        <td" + cl + ">" + rowNum + "</td>\n        <td" + cl + " style=\"min-width: 250px\">" + item.code + "</td>\n        <td" + cl + ">" + item.name + "</td>\n        <td" + cl + ">" + item.total_real_delivery + "</td>\n        <td" + cl + ">" + item.total_min_delivery + "</td>\n        <td" + cl + ">" + item.total_max_delivery + "</td>\n        <td" + cl + ">" + item.total_min + "</td>\n        <td" + cl + ">" + item.total_max + "</td>\n        <td" + cl + ">" + item.total_stock + "</td>\n        </tr>";
            }
        }
        else {
...
var _a, _b;
//# sourceMappingURL=G:/burgista/burgista-delivery-client/src/print.service.js.map
...
var rrule_1 = __webpack_require__(96);
...
//# sourceMappingURL=G:/burgista/burgista-delivery-client/src/product.model.js.map
...
//# sourceMappingURL=G:/burgista/burgista-delivery-client/src/WindowRef.js.map
...
var _a, _b, _c;
//# sourceMappingURL=G:/burgista/burgista-delivery-client/src/app.component.js.map
...
//# sourceMappingURL=G:/burgista/burgista-delivery-client/src/delivery.js.map
...
var WarningViewerComponent = (function () {
    function WarningViewerComponent(dialogRef, data) {
...
], WarningViewerComponent.prototype, "message", void 0);
WarningViewerComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof material_1.MdDialogRef !== "undefined" && material_1.MdDialogRef) === "function" && _a || Object, Object])
], WarningViewerComponent);
exports.WarningViewerComponent = WarningViewerComponent;
var _a;
//# sourceMappingURL=G:/burgista/burgista-delivery-client/src/warning-viewer.component.js.map
...
//# sourceMappingURL=G:/burgista/burgista-delivery-client/src/inventory.js.map
...
var _a, _b;
//# sourceMappingURL=G:/burgista/burgista-delivery-client/src/logged-in.guard.js.map
...
var PrintViewerComponent = (function () {
    ...
    PrintViewerComponent.prototype.ngOnInit = function () {
        ...
        if (!this.isOverallPrint) {
            this.itemList = this.printService.getItems();
        }
        else {
            this.itemList = this.printService.totalDeliveries;
        }
    };
...
var _a, _b;
//# sourceMappingURL=G:/burgista/burgista-delivery-client/src/print-viewer.component.js.map
...
//# sourceMappingURL=G:/burgista/burgista-delivery-client/src/product.js.map
...
var UnitModel = (function () {
    function UnitModel(unit) {
        ...
        this._unit.is_reporter = unit.is_reporter;
    }
...
//# sourceMappingURL=G:/burgista/burgista-delivery-client/src/unit.model.js.map
...
//# sourceMappingURL=G:/burgista/burgista-delivery-client/src/message.service.js.map
...
var _a, _b;
//# sourceMappingURL=G:/burgista/burgista-delivery-client/src/rest.service.js.map
...
//# sourceMappingURL=G:/burgista/burgista-delivery-client/src/main.js.map
...
//# sourceMappingURL=G:/burgista/burgista-delivery-client/src/app.module.js.map
...
//# sourceMappingURL=G:/burgista/burgista-delivery-client/src/counting-rule.component.js.map
...
var DeliveryFormComponent = (function () {
    function DeliveryFormComponent(authService, restService, msgService, dialog, printService) {
        ...
        this.dialog = dialog;
        this.printService = printService;
        this.onlyCountedBranches = false;
        this.delivery_types = exports.DELIVERY_TYPES;
        this.counted_products_tab_all = [];
        this.all_products_tab_all = [];
        this.tab_all = {
            deliveries: [],
            sum_total_real_delivery: 0,
            sum_total_min: 0,
            sum_total_max: 0,
            sum_total_min_delivery: 0,
            sum_total_max_delivery: 0,
            sum_total_stock: 0,
        };
        this.filteredBranchDeliveriesFa = {};
        this.showZeroDelivery = false;
        this.showCountedProduct = false;
    ...
    DeliveryFormComponent.prototype.checkDate = function (HourObject) {
        var startHour = HourObject.startHour, endHour = HourObject.endHour, startMin = HourObject.startMin, endMin = HourObject.endMin, startSec = HourObject.startSec, endSec = HourObject.endSec;
        ...
        if (selectedHour >= startHour && selectedHour <= endHour && selectedMin >= startMin && selectedMin <= endMin && selectedSecond >= startSec && selectedSecond <= endSec) {
    ...
    DeliveryFormComponent.prototype.onProductValueChanges$ = function () {
        ...
        this.productNameCodeCtrl.valueChanges.subscribe(function (data) {
            ...
            if (tempNameObj !== undefined && tempNameObj !== null) {
                ...
                tempDelivery.isCounted = tempDelivery['isCounted'];
    ...
    DeliveryFormComponent.prototype.getReceivers = function () {
        return __awaiter(this, void 0, void 0, function () {
            var data, _loop_1, this_1, _i, data_1, item, err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                    ...
                    case 1:
                        ...
                        _loop_1 = function (item) {
                            ...
                            if (this_1.isReporter) {
                                var usernameFound = ['depot', 'mprep'].find(function (username) { return username === item['username']; });
                                if (!usernameFound) {
                                    this_1.receivers.push(obj);
                                    this_1.isWaiting[obj.name] = false;
                                }
                            }
                            else {
                                this_1.receivers.push(obj);
    ...
    DeliveryFormComponent.prototype.dateChanged = function (date) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (moment(moment(date).format('YYYY-MM-DD')).isAfter(moment(this.currentDate).format('YYYY-MM-DD'))) {
                            this.selectedDate = new Date(this.selectedDate);
                            return [2, this.msgService.warn('Unable to report from future')];
                        }
                        this.counted_branch_names = [];
                        this.showCountedProduct = false;
                        return [4, this.getDateFromServer()];
                    case 1:
                        ...
                        if (selectedHour >= 0 && selectedHour <= 11 && selectedMin >= 0 && selectedMin <= 59 && selectedSecond >= 0 && selectedSecond <= 59) {
        ...
        if (this.selectedIndex === 0) {
            ...
            if (this.overallDeliveryModel._deliveries.length > 0) {
                ...
                this.receiversSumDeliveries['All'].max = this.overallDeliveryModel._deliveries
                    ...
                    .reduce(function (a, b) { return a + b; });
                this.receiversSumDeliveries['All'].oldCount = this.overallDeliveryModel._deliveries.filter(function (el) { return el.oldCount !== null; })
                    .map(function (el) { return el.oldCount; }).reduce(function (a, b) { return a + b; }, 0);
    ...
    DeliveryFormComponent.prototype.updateOverallDelivery = function (code, delivery, action, whichItem, changedValue) {
        switch (whichItem) {
            case 'min':
                ...
                break;
            case 'oldCount':
                this.overallDeliveryModel.updateDeliveryProperty(action, code, 'oldCount', changedValue);
                break;
            case 'max':
    ...
    DeliveryFormComponent.prototype.onlyPrintWithoutFinalized = function () {
        var _this = this;
        this.printService._isOverallPrint = true;
        this.printService._unitSupplier = 'Total';
        this.printService._unitConsumer = 'Aggregated';
        this.printService._showWarningMessage = false;
        this.printService.currentDate = this.currentDate;
        this.printService.totalDeliveries = this.tab_all.deliveries.slice();
    ...
    DeliveryFormComponent.prototype.deliverySubmitted = function (deliveryModel) {
        return __awaiter(this, void 0, void 0, function () {
            var insertItems, updateItems, deliveryItems, branchId, index, delivery, isToday, sendData, err_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        insertItems = [];
                        updateItems = [];
                        deliveryItems = deliveryModel._deliveries;
                        branchId = deliveryModel._deliveries[0]['uid'];
                        for (index = 0; index < deliveryItems.length; index++) {
                            delivery = deliveryItems[index];
                            isToday = moment(this.selectedDate).format('YYYY-MM-DD') === delivery['countingDate'];
                            updateItems.push({
                                bsddid: delivery['id'],
                        ...
                        sendData = {
                            'insert': insertItems,
                            'update': updateItems,
                            'delivery_submission_time': moment().format('YYYY-MM-DD HH:mm:ss')
                        };
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4, this.restService.insert("delivery/batch/" + branchId, sendData).toPromise()];
                    case 2:
                        _a.sent();
                        return [3, 4];
                    case 3:
    ...
    DeliveryFormComponent.prototype.submitDelivery = function (deliveryModel) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, this.restService.get('checkAccessTime').toPromise()];
                    case 1:
                        isAccess = _a.sent();
                        if (!isAccess) {
                            return [2, this.msgService.warn('you are able to delivered products from 22:00 PM until 12:00 PM tomorrow')];
                        }
                        return [2, this.deliverySubmitted(deliveryModel)];
                }
            });
        });
    };
    DeliveryFormComponent.prototype.onlyPrintReport = function () {
        var _this = this;
        this.receiversDeliveryModels[this.receiverName].uid;
        this.printService._unitSupplier = this.unitName;
        this.printService.uid = this.receiversDeliveryModels[this.receiverName].uid;
        this.printService._unitConsumer = this.receiverName;
        ...
        dialogRef.afterClosed().subscribe(function (data) {
            if (data === 'print') {
                if (!isAllTab) {
                    ...
                    var counter_1 = 0;
                    var deliveryItems_1 = deliveryModel._deliveries;
                    var _loop_2 = function (item) {
                        ...
                        _this.restService.update('delivery', item.id, delivery_model_1.DeliveryModel.toAnyObject(item, item.isPrinted, null)).subscribe(function (data) {
                            ...
                            counter_1++;
                            if (counter_1 >= deliveryItems_1.length)
                    ...
                    for (var _i = 0, deliveryItems_2 = deliveryItems_1; _i < deliveryItems_2.length; _i++) {
    ...
    DeliveryFormComponent.prototype.getDeliveryData = function () {
        return __awaiter(this, void 0, void 0, function () {
            var dateParam, serverDate, index, receiver, data, name, err_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 5:
                        ...
                        if (this.receivers['length'] === index + 1) {
                            for (name in this.receiversDeliveryModels)
                                if (this.receiversDeliveryModels.hasOwnProperty(name)) {
                                    this.receiversDeliveryModels[name].filter = false;
                                    this.filteredBranchDeliveriesFa[name] = this.receiversDeliveryModels[name].deliveries;
                                }
                            this.calculateTotalDeliveries(this.filteredBranchDeliveriesFa);
                        }
                        return [3, 7];
                    case 6:
                        err_3 = _a.sent();
    ...
    DeliveryFormComponent.prototype.setDelivery = function (data, rcv) {
        ...
        this.receiversSumDeliveries[rcv.name].oldCount = 0;
        for (var _i = 0, data_2 = data; _i < data_2.length; _i++) {
            ...
            tempDelivery.isCounted = item.isCounted;
            tempDelivery.ref_id = item.ref_id;
            tempDelivery.product_id = item.productId;
            tempDelivery.countingDate = moment(item.counting_date).format('YYYY-MM-DD');
            ;
            ...
            if (this.overallDeliveryModel.getByCode(item.productCode) === undefined) {
                ...
                this.updateOverallDelivery(item.productCode, tempDelivery, 'add', 'oldCount', tempDelivery.oldCount);
        ...
        if (operation === 'add') {
            if ((delivery.stock === null || delivery.id === null)) {
                if (rcvName !== 'All') {
                    ...
                    this.receiversSumDeliveries['All'].oldCount = null;
                }
            }
            this.receiversSumDeliveries[rcvName].min += delivery.min;
            this.receiversSumDeliveries[rcvName].max += delivery.max;
            this.receiversSumDeliveries[rcvName].oldCount += delivery.oldCount;
    ...
    DeliveryFormComponent.prototype.calculateTotalDeliveries = function (branches) {
        var new_branches = this.removeAndClearSomeBranchesForTotalCalculate(branches).new_branches;
        var deliveries = this.getAggregateDeliveries(__assign({}, new_branches));
        var products_deliveries = this.filterDeliveriesBaseOnProduct(deliveries);
        var final_product_with_total_deliveries = this.calculateTotalDeliveriesPerProduct(products_deliveries);
        this.calculateSumTotalTabAll(final_product_with_total_deliveries);
        this.calculateSumTotalAllProducts(final_product_with_total_deliveries.slice());
        this.calculateSumTotalProductsCounted(final_product_with_total_deliveries.slice());
    };
    DeliveryFormComponent.prototype.removeAndClearSomeBranchesForTotalCalculate = function (branches) {
        var filterKeys = ['All', 'depot', 'Main Prep'];
        var new_branches = __assign({}, branches);
        delete new_branches[filterKeys[0]];
        delete new_branches[filterKeys[1]];
        delete new_branches[filterKeys[2]];
        return {
            new_branches: new_branches
        };
    };
    DeliveryFormComponent.prototype.calculateSumTotalProductsCounted = function (products) {
        this.counted_products_tab_all = products.filter(function (product) { return product['total_stock'] !== null; });
    };
    DeliveryFormComponent.prototype.calculateSumTotalAllProducts = function (products) {
        this.all_products_tab_all = products;
    };
    DeliveryFormComponent.prototype.calculateSumTotalTabAll = function (products) {
        this.tab_all.deliveries = products;
        this.tab_all['sum_total_real_delivery'] = this.calculateSumBaseOnKey(products, 'total_real_delivery');
        this.tab_all['sum_total_min'] = this.calculateSumBaseOnKey(products, 'total_min');
        this.tab_all['sum_total_max'] = this.calculateSumBaseOnKey(products, 'total_max');
        this.tab_all['sum_total_max_delivery'] = this.calculateSumBaseOnKey(products, 'total_max_delivery');
        this.tab_all['sum_total_min_delivery'] = this.calculateSumBaseOnKey(products, 'total_min_delivery');
        this.tab_all['sum_total_stock'] = this.calculateSumBaseOnKey(products, 'total_stock');
    };
    DeliveryFormComponent.prototype.calculateSumBaseOnKey = function (products, key) {
        var sum = 0;
        products.forEach(function (product) {
            sum += product[key] === null ? 0 : product[key];
        });
        return sum;
    };
    DeliveryFormComponent.prototype.calculateTotalDeliveriesPerProduct = function (products, is_counted) {
        var _this = this;
        if (is_counted === void 0) { is_counted = false; }
        var result = [];
        products.forEach(function (product) {
            var deliveries = product.deliveries;
            product = _this.clearProductTotalAmount(product);
            product['total_real_delivery'] = _this.calculateTotalAmountBaseOnKey(deliveries, 'realDelivery', is_counted);
            product['total_min'] = _this.calculateTotalAmountBaseOnKey(deliveries, 'min', is_counted);
            product['total_max'] = _this.calculateTotalAmountBaseOnKey(deliveries, 'max', is_counted);
            product['total_stock'] = _this.calculateTotalAmountBaseOnKey(deliveries, 'stock', is_counted);
            product['total_min_delivery'] = _this.calculateTotalAmountBaseOnKey(deliveries, 'minDelivery', is_counted);
            product['total_max_delivery'] = _this.calculateTotalAmountBaseOnKey(deliveries, 'maxDelivery', is_counted);
            result.push(product);
        });
        return result;
    };
    DeliveryFormComponent.prototype.clearProductTotalAmount = function (product) {
        product['total_real_delivery'] = 0;
        product['total_min'] = 0;
        product['total_max'] = 0;
        product['total_stock'] = 0;
        product['total_min_delivery'] = 0;
        product['total_max_delivery'] = 0;
        return product;
    };
    DeliveryFormComponent.prototype.calculateTotalAmountBaseOnKey = function (deliveries, key, is_counted) {
        var _this = this;
        if (is_counted === void 0) { is_counted = false; }
        var total = 0;
        var total_items = [];
        deliveries.forEach(function (delivery) {
            total_items.push(delivery[key]);
            if (is_counted) {
                if (delivery['isCounted']) {
                    total += delivery[key] === null ? 0 : delivery[key];
                    if (_this.counted_branch_names.filter(function (x) { return x === delivery['branch_name']; }).length === 0) {
                        _this.counted_branch_names.push(delivery['branch_name']);
                    }
                }
            }
            else {
        ...
        var is_not_counted = total_items['length'] && total_items.every(function (el) { return el === null; });
        return is_not_counted ? null : total;
    };
    DeliveryFormComponent.prototype.filterDeliveriesBaseOnProduct = function (deliveries) {
        var _this = this;
        var products = [];
        deliveries.forEach(function (delivery) {
            var productFound = products.find(function (product) { return product['id'] === delivery['product_id']; });
            if (!productFound) {
                products.push({
                    id: delivery['product_id'],
                    code: delivery['productCode'],
                    name: delivery['productName'],
                    total_min: 0,
                    total_max: 0,
                    total_min_delivery: 0,
                    total_max_delivery: 0,
                    total_stock: 0,
                    deliveries: [_this.getDeliveryObj(delivery)]
                });
            }
            else {
                productFound['deliveries'].push(_this.getDeliveryObj(delivery));
            }
        });
        return products;
    };
    DeliveryFormComponent.prototype.getDeliveryObj = function (delivery) {
        return {
            stock: delivery['stock'],
            isCounted: delivery['stock'] === null ? false : true,
            realDelivery: delivery['realDelivery'],
            minDelivery: delivery['minDelivery'],
            maxDelivery: delivery['maxDelivery'],
            min: delivery['min'],
            max: delivery['max'],
            branch_name: delivery['branch_name'],
        };
    };
    DeliveryFormComponent.prototype.getAggregateDeliveries = function (branches) {
        var deliveries_all = [];
        var _loop_3 = function (branch_name) {
            if (branches.hasOwnProperty(branch_name)) {
                var deliveries = branches[branch_name];
                deliveries.forEach(function (delivery) {
                    delivery['branch_name'] = branch_name;
                });
                deliveries_all = deliveries_all.concat(deliveries);
            }
        };
        for (var branch_name in branches) {
            _loop_3(branch_name);
        }
        return deliveries_all;
    };
    DeliveryFormComponent.prototype.showAllOrCounted = function (event) {
        this.counted_branch_names = [];
        if (event.value) {
            this.onlyCountedBranches = true;
            var cloneData = this.counted_products_tab_all.slice();
            this.calculateSumTotalTabAll(this.calculateTotalDeliveriesPerProduct(cloneData, true));
        }
        else {
            this.onlyCountedBranches = false;
            var cloneData = this.all_products_tab_all.slice();
            this.calculateSumTotalTabAll(this.calculateTotalDeliveriesPerProduct(cloneData));
        }
    };
...
var _a, _b, _c, _d, _e;
//# sourceMappingURL=G:/burgista/burgista-delivery-client/src/delivery-form.component.js.map
...
//# sourceMappingURL=G:/burgista/burgista-delivery-client/src/delivery.model.js.map
...
var _a, _b;
//# sourceMappingURL=G:/burgista/burgista-delivery-client/src/focus.directive.js.map
...
//# sourceMappingURL=G:/burgista/burgista-delivery-client/src/home.component.js.map
...
//# sourceMappingURL=G:/burgista/burgista-delivery-client/src/index.js.map
...
var InventoryFormComponent = (function () {
    function InventoryFormComponent(authService, restService, dialog, messageService) {
        ...
        this.isFirstTimeFillsForm = true;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        this.currentDate = new Date(d);
                        this.selectedDate = new Date(d);
                        if (this.dateIsBetween('00:00:01', '11:59:59')) {
                            this.isPreviousDay = true;
                            this.selectedDate = new Date(moment(this.selectedDate).subtract(1, 'day').toDate());
                        }
    ...
    InventoryFormComponent.prototype.dateIsBetween = function (fromTime, untilTime) {
        var date = moment(this.currentDate).subtract(1, 'day').toDate();
        var currentDate = moment(date).format('YYYY-MM-DD');
        var currentDateTime = moment(date).format('YYYY-MM-DD HH:mm:ss');
        var fromDateTime = moment(currentDate + " " + fromTime).format('YYYY-MM-DD HH:mm:ss');
        var untilDateTime = moment(currentDate + " " + untilTime).format('YYYY-MM-DD HH:mm:ss');
    ...
    InventoryFormComponent.prototype.openWarningDialog = function () {
        var _this = this;
        var dialogOpen = this.dialog.open(warning_viewer_component_1.WarningViewerComponent, {
            width: '40%',
            data: {
                message: 'The values entered for some products are greater than the maximum, so be sure to confirm'
            }
        });
    ...
    InventoryFormComponent.prototype.submitInventories = function () {
        return __awaiter(this, void 0, void 0, function () {
            var canInventoryTaking;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, this.checkStockOfBranchIsFinalized()];
                    case 1:
                        canInventoryTaking = _a.sent();
                        if (canInventoryTaking) {
                            this.checkUnopenedPackGreaterThanMaxStock();
                        }
                        else {
                            this.inventoryModel._inventories.forEach(function (el) {
                                el.unopenedPack = el.unopenedPackTemp;
                            });
                        }
                        return [2];
                }
    ...
    InventoryFormComponent.prototype.checkStockOfBranchIsFinalized = function () {
        return __awaiter(this, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, this.restService.insert('checkBranchStockFinalized', { date: this.selectedDate }).toPromise()];
                    case 1:
                        result = _a.sent();
                        if (result) {
                            this.isSameDates = false;
                            this.messageService.warn('You cannot modify the stocks that delivered');
                            return [2, false];
                        }
                        return [2, true];
                }
    ...
    InventoryFormComponent.prototype.inventoriesSaved = function () {
        ...
        for (var index = 0; index < this.inventoryModel._inventories.length; index++) {
            ...
            var isToday = moment(this.selectedDate).format('YYYY-MM-DD') === inventory['countingDate'];
            if (inventory['ref_type_id'] === this.delivery_types.IS_NEW_PRODUCT && !inventory['id']) {
                insertItems.push(inventory_model_1.InventoryModel.toAnyObject(inventory));
            }
            else {
                if (!inventory['ref_type_id'] && isToday) {
                ...
                if (inventory['ref_type_id'] && !isToday) {
                    var refId = inventory['id'];
                    delete inventory['id'];
                    inventory['ref_id'] = refId;
                    insertItems.push(inventory_model_1.InventoryModel.toAnyObject(inventory));
                    updateItems.push({
                        bsddid: refId,
                        ref_type_id: this.delivery_types.CLOSED
                    });
                }
            }
        }
        ...
        this.restService.insert('stock/batch', sendData).subscribe(function (data) {
            ...
            timers_1.setTimeout(function () {
                ...
                _this.isFirstTimeFillsForm = false;
    ...
    InventoryFormComponent.prototype.removeInventoryItem = function (inventoryItem) {
        var _this = this;
        if (inventoryItem.ref_type_id === this.delivery_types.IS_NEW_PRODUCT && inventoryItem.id) {
            var dialogOpen = this.dialog.open(warning_viewer_component_1.WarningViewerComponent, {
                width: '40%',
                data: {
                    message: "Are you sure you want to delete [" + inventoryItem['productName'] + "]?"
                }
            });
            dialogOpen.afterClosed().subscribe(function (status) {
                if (status) {
                    ...
                    return _this.removeStockFromDB(inventoryItem);
                }
            });
        }
        else {
    ...
    InventoryFormComponent.prototype.dateChanged = function (date) {
        this.isPreviousDay = false;
        var currentTime = moment(this.currentDate).format('HH:mm:ss');
        var dateTimeSelected = moment(moment(date).format('YYYY-MM-DD') + " " + currentTime).format('YYYY-MM-DD HH:mm:ss');
        var currentDate = moment(this.currentDate).format('YYYY-MM-DD');
        var previousDate = moment(this.currentDate).subtract(1, 'day').format('YYYY-MM-DD');
        var previousDateTimeSelected = moment(moment(date).format('YYYY-MM-DD') + " " + currentTime).subtract(1, 'day').format('YYYY-MM-DD HH:mm:ss');
        var dateSelected = moment(date).format('YYYY-MM-DD');
        var fromTime = moment(currentDate + " 00:00:01");
        var untilTme = moment(currentDate + " 11:59:59");
        if (previousDate === dateSelected && moment(previousDateTimeSelected).isBetween(fromTime, untilTme, null, '[]')) {
            this.isPreviousDay = true;
            this.selectedDate = this.selectedDate;
        }
        if (!this.isPreviousDay && currentDate === dateSelected && moment(dateTimeSelected).isBetween(fromTime, untilTme, null, '[]')) {
            this.selectedDate = new Date(this.selectedDate);
            return this.messageService.warn('Unable to report from future');
        }
        if (!this.isPreviousDay && moment(dateTimeSelected).isAfter(moment(this.currentDate).format('YYYY-MM-DD HH:mm:ss'))) {
            this.selectedDate = new Date(this.selectedDate);
            return this.messageService.warn('Unable to report from future');
        }
    ...
    InventoryFormComponent.prototype.getInventoryData = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            var dateParam;
            return __generator(this, function (_a) {
                dateParam = moment(this.selectedDate).format('YYYYMMDD');
                this.restService.get('stock/' + dateParam).subscribe(function (data) { return __awaiter(_this, void 0, void 0, function () {
                    var _i, data_1, item, tempInventory, lastCount;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                this.inventoryModel.clear();
                                ...
                                for (_i = 0, data_1 = data; _i < data_1.length; _i++) {
                                    ...
                                    if (item.counting_date === null) {
                                        ...
                                        tempInventory = new inventory_1.Inventory();
                                        tempInventory.id = item.bsddid;
                                        tempInventory.productId = item.pid;
                                        tempInventory.countingDate = moment(item.counting_date).format('YYYY-MM-DD');
                                        ...
                                        tempInventory.unopenedPackTemp = item.product_count;
                                        ...
                                        if (item.last_count === null)
                                            ...
                                            lastCount = moment(item.last_count).format('YYYY-MM-DD');
                                ...
                                this.checkInventoryItemsAlreadySubmitted();
                                this.noButton = this.inventoryModel._inventories.map(function (r) { return r.shouldIncluded; }).reduce(function (x, y) { return x && y; }, true);
    ...
    InventoryFormComponent.prototype.checkInventoryItemsAlreadySubmitted = function () {
        ...
        this.isUpdateMode = _inventories.every(function (el) { return el['id'] && el.submission_time !== null; });
        if (this.isUpdateMode) {
            this.isFirstTimeFillsForm = false;
    ...
    InventoryFormComponent.prototype.loadProducts = function () {
        return __awaiter(this, void 0, void 0, function () {
            var products, product_ids_exists_1, err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4, this.restService.get('product/all').toPromise()];
                    case 1:
                        products = _a.sent();
                        product_ids_exists_1 = this.inventoryModel._inventories.map(function (el) { return el['productId']; });
                        product_ids_exists_1 = Array.from(new Set(product_ids_exists_1));
                        products = products.filter(function (p) { return !product_ids_exists_1.find(function (pId) { return pId === p['pid']; }); });
                        this.products = products.map(function (p) {
                            return __assign({}, p, { name_code: p.code + " - " + p.name });
                        });
                        this.productName_Code = products.sort(function (a, b) {
                        ...
                        }).map(function (r) { return r.code + " - " + r.name; });
                        return [3, 3];
                    case 2:
                        err_1 = _a.sent();
                        console.error('an error occurred during fetching products', err_1);
                        return [3, 3];
                    case 3: return [2];
                }
            });
    ...
    InventoryFormComponent.prototype.productSelected = function (name_code) {
        var product = this.products.find(function (el) { return el['name_code'] === name_code; });
        var tempInventoryItem = new inventory_1.Inventory();
        tempInventoryItem.id = null;
        tempInventoryItem.ref_id = null;
        tempInventoryItem.ref_type_id = this.delivery_types.IS_NEW_PRODUCT;
        tempInventoryItem.unopenedPack = null;
        tempInventoryItem.productCode = product['code'];
        tempInventoryItem.productName = product['name'];
        tempInventoryItem.productId = product['pid'];
        tempInventoryItem.lastCount = new Date(this.currentDate.getFullYear(), this.currentDate.getMonth(), this.currentDate.getDate());
        tempInventoryItem.isNew = true;
        tempInventoryItem.shouldIncluded = false;
        this.inventoryModel.add(tempInventoryItem);
        this.checkDisability(tempInventoryItem);
        this.productNameCodeCtrl.setValue(null);
        this.productName_Code = this.productName_Code.filter(function (el) {
            return el.toLowerCase() !== name_code.toLowerCase();
        });
    };
    InventoryFormComponent.prototype.removeStockFromDB = function (inventory) {
        return __awaiter(this, void 0, void 0, function () {
            var err_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4, this.restService.delete('stock', inventory['id']).toPromise()];
                    case 1:
                        _a.sent();
                        this.messageService.message(inventory['productName'] + " removed");
                        return [3, 3];
                    case 2:
                        err_2 = _a.sent();
                        console.error('an error occurred during delete stock from stocks', err_2);
                        return [3, 3];
                    case 3: return [2];
                }
            });
...
var _a, _b, _c, _d;
//# sourceMappingURL=G:/burgista/burgista-delivery-client/src/inventory-form.component.js.map
...
//# sourceMappingURL=G:/burgista/burgista-delivery-client/src/inventory.model.js.map
...
var _a;
//# sourceMappingURL=G:/burgista/burgista-delivery-client/src/login.component.js.map
...
var NavbarComponent = (function () {
    function NavbarComponent(authService, router, restService) {
        this.authService = authService;
        this.router = router;
        this.restService = restService;
        this.navLinks = [];
    ...
    NavbarComponent.prototype.ngOnInit = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, this.restService.get('date').toPromise()];
                    case 1:
                        date = _a.sent();
                        this.currentDate = new Date(date);
                        setInterval(function () {
                            _this.currentDate = new Date(_this.currentDate.setSeconds(_this.currentDate.getSeconds() + 1));
                        }, 1000);
...
var _a, _b, _c;
//# sourceMappingURL=G:/burgista/burgista-delivery-client/src/navbar.component.js.map
...
var actionEnum_1 = __webpack_require__(88);
var message_service_1 = __webpack_require__(35);
...
var _a, _b, _c, _d;
//# sourceMappingURL=G:/burgista/burgista-delivery-client/src/override-form.component.js.map
...
var _a, _b, _c;
//# sourceMappingURL=G:/burgista/burgista-delivery-client/src/product-form.component.js.map
...
//# sourceMappingURL=G:/burgista/burgista-delivery-client/src/product-sub-form.component.js.map
...
var _a, _b;
//# sourceMappingURL=G:/burgista/burgista-delivery-client/src/reports.component.js.map
...
//# sourceMappingURL=G:/burgista/burgista-delivery-client/src/monthday.component.js.map
...
//# sourceMappingURL=G:/burgista/burgista-delivery-client/src/rrule.component.js.map
...
var SubFormComponent = (function () {
    ...
    SubFormComponent.prototype.ngOnInit = function () {
        ...
        if (this.isAdd) {
            ...
            if (this.unitModel._unit.is_reporter) {
                this.formTitle = this.unit.name + " - Reporter";
                this.unit.is_reporter = this.unitModel._unit.is_reporter;
    ...
    SubFormComponent.prototype.actionEmitter = function (clickType) {
        var value = {
            type: clickType,
            data: __assign({}, this.unit)
        };
        if (this.unit.is_reporter) {
            value.data.is_branch = false;
        }
        this.action.emit(value);
    };
    SubFormComponent.prototype.isCorrectFormData = function (isForAdd) {
        this.unit.is_reporter = false;
        if (this.unit.name !== "" && this.unit.username !== "" && this.unit.is_branch === null && this.unit.is_kitchen !== null) {
            this.unit.is_reporter = true;
            return true;
        }
...
var _a;
//# sourceMappingURL=G:/burgista/burgista-delivery-client/src/sub-form.component.js.map
    ...
    UnitFormComponent.prototype.ngOnInit = function () {
        ...
        this.restService.get('unit').subscribe(function (data) {
            ...
            for (var _i = 0, data_1 = data; _i < data_1.length; _i++) {
                ...
                unit.is_branch = unitData.is_branch;
                unit.is_kitchen = unitData.is_kitchen;
                unit.is_reporter = unitData.is_reporter;
                var unitModel = new unit_model_1.UnitModel(unit);
                _this.unitModels.push(unitModel);
            }
...
var _a, _b;
//# sourceMappingURL=G:/burgista/burgista-delivery-client/src/unit-form.component.js.map
...
//# sourceMappingURL=G:/burgista/burgista-delivery-client/src/environment.js.map
...
//# sourceMappingURL=G:/burgista/burgista-delivery-client/src/polyfills.js.map
...
var AuthService = (function () {
    function AuthService(restService, router, messageService) {
        ...
        this.userType = '';
        this.unitName = '';
        this.auth$ = new BehaviorSubject_1.BehaviorSubject(false);
...
var _a, _b, _c;
//# sourceMappingURL=G:/burgista/burgista-delivery-client/src/auth.service.js.map
...
//# sourceMappingURL=G:/burgista/burgista-delivery-client/src/actionEnum.js.map
